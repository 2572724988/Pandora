...
def toonAccounts(keuze, zoekterm, m_email):
    ...
    werknemers = Table('werknemers', metadata,
        ...
        Column('accountID', None, ForeignKey('lonen.loonID')))
    ...
    if keuze == 5:
        ...
        header2 = ['Accountnummer',' Werknemernummer', 'Loonschaal']
        ...
        if idx.column() == 0:
            ...
            class Widget(QDialog):
                def __init__(self, parent=None):
                    ...
                    q2Edit.setStyleSheet("QLineEdit { background-color: ; color: black }")
                    ...
                    q3Edit.setStyleSheet("QLineEdit { background-color: ; color: black }")
                    ...
                    q4Edit.setStyleSheet("QLineEdit { background-color: ; color: black }")
                    ...
                    q5Edit.setStyleSheet("QLineEdit { background-color: ; color: black }")
                    ...
                    q7Edit.setStyleSheet("QLineEdit { background-color: ; color: black }")
                    ...
                    q8Edit.setStyleSheet("QLineEdit { background-color: ; color: black }")
                    ...
                    q9Edit.setStyleSheet("QLineEdit { background-color: ; color: black }")
                    ...
                    q11Edit.setStyleSheet("QLineEdit { background-color: ; color: black }")
                    ...
                    q15Edit.setStyleSheet("QLineEdit { background-color: ; color: black }")
                    ...
                    q17Edit.setStyleSheet("QLineEdit { background-color: ; color: black }")
