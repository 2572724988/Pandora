...
def printWerkbrief(mwerkorder, rpord, header):
    ...
    if platform == 'win32':
        ...
        filename1 = './forms/Werkbrieven/werkgeleidebrief_'+str(mwerkorder)+'.txt'
    kop1=\
     ('Werkorder: '+mwerkorder+' Werkgeleidebrief  Datum: '+str(datetime.datetime.now())[0:10]+' Blad : '+str(mblad)+'\n'\
     '=====================================================================================================\n'+
        ...
        if  idx.column() == 0:
            ...
            class MainWindow(QDialog):
                def __init__(self):
                    ...
                    q4Edit = QLineEdit(str(round(rpord[3],2)))
