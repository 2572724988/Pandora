...
def toonArtikelen(keuze,zoekterm, m_email):
    ...
    if keuze == 1:
        ...
        sel = select([artikelen]).where(and_(artikelen.c.reserveringsaldo > 0,\
                     ...
                     artikelen.c.reserveringsaldo,artikelen.c.categorie >3))
    elif keuze == 8:
        sel = select([artikelen]).where(artikelen.c.art_voorraad < artikelen.c.art_min_voorraad)
    elif keuze == 9:
        ...
        if idx.column() == 0:
            ...
            class Widget(QDialog):
                def __init__(self):
                    ...
                    q16Edit = QLineEdit(str(rpartikel[13]))
                    ...
                    q12Edit = QLineEdit(str(rpartikel[14]))
