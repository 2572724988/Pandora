...
from PyQt5.QtWidgets import QWidget, QMessageBox, QDialog, QStyledItemDelegate,\
      QTableView, QVBoxLayout, QLabel, QLineEdit, QGridLayout, QPushButton
from sqlalchemy import (Table, Column, Integer, String, Float, MetaData, \
                            ForeignKey, create_engine, DateTime, desc, select, and_)
    ...
    class MyTableModel(QAbstractTableModel):
        ...
        def data(self, index, role):
            if not index.isValid():
                return None
            #elif index.column() == 8 and role == Qt.DecorationRole:
