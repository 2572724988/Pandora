        ...
        if  idx.column() == 0:
            ...
            class Widget(QDialog):
                def __init__(self):
                    ...
                    self.Gereed = QLabel()
                    q6Edit = QLineEdit(str(round(rpord[19], 2)))
                    ...
                    q7Edit = QLineEdit(str(round(rpord[18],2)))
                    ...
                    grid.addWidget(lbl8, 5, 1, 1, 2, Qt.AlignCenter)
                    lbl9 = QLabel('                 Bestelhoeveelheid: '+str(rpord[17]))
                    grid.addWidget(lbl9, 6, 1, 1, 2, Qt.AlignCenter)
