    ...
    class MyTableModel(QAbstractTableModel):
        ...
        def data(self, index, role):
            if not index.isValid():
                return None
            #elif index.column() == 27 and role == Qt.DecorationRole:
        ...
        if idx.column() == 0:
            ...
            class Widget(QDialog):
                 def __init__(self, parent=None):
                    ...
                    q22Edit = QLineEdit(str(rpordartlev[8]))
                    ...
                    q24Edit = QLineEdit(str(rpordartlev[10]))
