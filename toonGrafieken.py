...
def printGrafiek(keuze, jrwk, m_email):
    class Widget(QDialog):
        def __init__(self, parent=None):
            ...
            axisX.append(jaar+"-01", 1)  
            axisX.append(jaar+"-02", 2)  
            axisX.append(jaar+"-03", 3)  
            axisX.append(jaar+"-04", 4)
            axisX.append(jaar+"-05", 5)
            axisX.append(jaar+"-06", 6)
            axisX.append(jaar+"-07", 7)
            axisX.append(jaar+"-08", 8)
            axisX.append(jaar+"-09", 9)
            axisX.append(jaar+"-10", 10)
            axisX.append(jaar+"-11", 11)
            axisX.append(jaar+"-12", 12)
            axisX.append(jaar+"-13", 13)
            axisX.append(jaar+"-14", 14)
            axisX.append(jaar+"-15", 15)
            axisX.append(jaar+"-16", 16)
            axisX.append(jaar+"-17", 17)
            axisX.append(jaar+"-18", 18)
            axisX.append(jaar+"-19", 19)
            axisX.append(jaar+"-20", 20)
            axisX.append(jaar+"-21", 21)
            axisX.append(jaar+"-22", 22)
            axisX.append(jaar+"-23", 23) 
            axisX.append(jaar+"-24", 24)
            axisX.append(jaar+"-25", 25)    
            axisX.append(jaar+"-26", 26)
            axisX.append(jaar+"-27", 27)
            axisX.append(jaar+"-28", 28)
            axisX.append(jaar+"-29", 29)
            axisX.append(jaar+"-30", 30)
            axisX.append(jaar+"-31", 31)
            axisX.append(jaar+"-32", 32) 
            axisX.append(jaar+"-33", 33)
            axisX.append(jaar+"-34", 34)
            axisX.append(jaar+"-35", 35) 
            axisX.append(jaar+"-36", 36) 
            axisX.append(jaar+"-37", 37)    
            axisX.append(jaar+"-38", 38) 
            axisX.append(jaar+"-39", 39)
            axisX.append(jaar+"-40", 40) 
            axisX.append(jaar+"-41", 41)
            axisX.append(jaar+"-42", 42)
            axisX.append(jaar+"-43", 43)
            axisX.append(jaar+"-44", 44)         
            axisX.append(jaar+"-45", 45)
            axisX.append(jaar+"-46", 46) 
            axisX.append(jaar+"-47", 47)
            axisX.append(jaar+"-48", 48)
            axisX.append(jaar+"-49", 49)
            axisX.append(jaar+"-50", 50)
            axisX.append(jaar+"-51", 51)
            axisX.append(jaar+"-52", 52)
            axisX.append(jaar+"-53", 53)
            axisX.setRange(0, 53)
